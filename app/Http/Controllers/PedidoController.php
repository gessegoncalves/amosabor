...
use App\Eventos\Repositories\IPedidoRepository as repository;
...
class PedidoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //  dd($itens[0]->getItensPedido);

        // dd($itens[0]->getCliente);
         return view('painel.pedidos')->with(compact('itens')) ;
